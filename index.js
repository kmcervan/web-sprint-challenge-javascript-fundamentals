...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* The nested function can access the variable internally because it is within the scope of the function
  the function can also pull in information from the global scope, but other functions cannot get information
  from myFunction because unless you specially call apon that info, whatever information from it's local scope
  stays within it's local scope. */


/* 🚀🚀🚀 Task 2: Counter 🚀🚀🚀 */
/* Create a function called `summation` that accepts a parameter and uses a counter to return the summation 
of that number. For example, `summation(4)` should return 10 because 1+2+3+4 is 10. Note, you may use a 
for loop for this function if you wish */
...
const zooAnimals = [
  ...
  */
  ...
  new array of objects called lowPopulationAnimals which contains only the animals with a 
...
// 🦁🦁🦁 Create a function named multiply that returns the product of two numbers 🦁🦁🦁
 ...
 // 🦁🦁🦁 Create a function named greeting that accepts a first and last name and returns "Hello first-name last-name, nice to meet you!" 🦁🦁🦁
  ...
  // console.log(consume('karla', 'cervantes', greeting));
...
/* 🐴🐴🐴 Step 1: Base Constructor 🐴🐴🐴
  Create a constructor function named CuboidMaker that accepts properties for length, width, and height which 
...
// 🦄🦄🦄 Topic 4: Classes 🦄🦄🦄 //
//🦄🦄🦄 1. Take your prototypes from above and refactor into class syntax. Please rename your class CuboidMakerTwo and 
//your object cuboidTwo 🦄🦄🦄
